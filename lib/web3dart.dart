...
class Web3dart {
  ...
  String rpcUrl = "http://13.228.169.26:8545";
  int chainId = 2021;
  ...
  DeployedContract getEurusInternalConfig(){
    ...
    EthereumAddress.fromHex('0x1Cd2A22fb0e5E2c6811C833019721CF9152c8063');
    String abiCode =
  ...
  DeployedContract getExternalSmartContractConfig(){
    final EthereumAddress contractAddr =
    EthereumAddress.fromHex('0x4337e715432E34AC6Fb0D2655274a07d8bd6a000');
    String abiCode =
