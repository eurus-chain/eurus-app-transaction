...
class Web3dart {
  ...
  /// sendETHTransaction
  Future<String> sendETHFromMainNet(
  ...
  Future<String> sendETHFromEurus({BigInt amount, String toAddress}) async {
    EthereumAddress toETHAddress = EthereumAddress.fromHex(toAddress);
  ...
  Future<String> sendERC20FromMainNet(
  ...
  /// sendERC20Transaction
  Future<String> sendERC20FromEurus(
      {String contractAddress, BigInt amount, String toAddress}) async {
    EthereumAddress toETHAddress = EthereumAddress.fromHex(toAddress);
    final EthereumAddress contractAddr =
        EthereumAddress.fromHex(contractAddress);
    ...
    String sendTransaction = await eurusEthClient.sendTransaction(
        credentials,
        Transaction.callContract(
          contract: contract,
          function: transferEvent,
